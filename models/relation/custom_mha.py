...
def multi_head_attention_forward(
    ...
    if has_torch_function(tens_ops):
        assert False, 'Currently custom MHA does not support torch ops'
    ...
    attn_output_weights_raw = attn_output_weights + 0
    ...
    if need_weights:
        ...
        return attn_output, attn_output_weights_raw.sum(dim=1) / num_heads
    else:
